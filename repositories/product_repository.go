...
func (repo *ProductRepository) GetAll() ([]models.Product, error) {
	query := "SELECT a.id, a.name, a.price, a.stock, b.id, b.name FROM products a, categories b WHERE b.id = a.category_id"
...
func (repo *ProductRepository) GetByID(id int) (*models.Product, error) {
	query := "SELECT a.id, a.name, a.price, a.stock, b.id, b.name FROM products a, categories b WHERE a.id = $1 and a.category_id = b.id"
